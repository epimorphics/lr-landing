...
Rails.application.configure do
  ...
  config.sentry = {
    band: ENV.fetch('SENTRY_BAND', 'test'),
    enabled: ENV.fetch('SENTRY_ENABLED', false),
    environment: ENV.fetch('SENTRY_ENVIRONMENT', 'test'),
    hostname: ENV.fetch('SENTRY_HOSTNAME', 'localhost')
  }
end
